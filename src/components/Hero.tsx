...
import { Check, ShieldCheck, Scale, MessageSquareCode } from 'lucide-react';
    ...
    <section className="relative min-h-[92vh] lg:min-h-screen bg-black flex flex-col justify-center overflow-hidden pt-6 pb-12 px-4 sm:px-6 lg:px-12">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center z-10 my-auto">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
          ...
          {/* OAB Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#111111] border border-[#C8A45B]/30 text-xs font-semibold text-[#E6C97A] tracking-wider uppercase">
            <ShieldCheck className="w-4 h-4 text-[#C8A45B]" />
            <span>Advocacia Especializada & Atendimento Nacional</span>
          </div>

          {/* Headline */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-[1.15] tracking-tight font-sora">
            Especialista em <span className="text-gold-gradient">recuperação de valores</span> e defesa dos seus direitos.
          </h1>

          {/* Subtitle */}
          <p className="text-base sm:text-lg text-gray-300 max-w-2xl font-normal leading-relaxed">
            Atendimento jurídico altamente especializado em <strong className="text-white font-semibold">Golpe do PIX</strong>, <strong className="text-white font-semibold">Ludopatia</strong> (apostas/bets) e <strong className="text-white font-semibold">Direito Trabalhista</strong>.
          </p>

          {/* Checkmarks */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-3 sm:gap-6 pt-2 text-sm text-gray-200">
            ...
            <div className="flex items-center gap-2.5 bg-[#111111]/80 border border-white/5 px-3.5 py-2 rounded-lg">
              ...
              <span className="font-medium">Análise inicial do caso</span>
            </div>
            ...
            <div className="flex items-center gap-2.5 bg-[#111111]/80 border border-white/5 px-3.5 py-2 rounded-lg">
              ...
              <span className="font-medium">Atendimento online para todo Brasil</span>
            </div>
          </div>
          ...
          <div className="pt-4 w-full sm:w-auto">
            ...
            >
              ...
              <span>QUERO UMA ANÁLISE DO MEU CASO</span>
            </button>
            <p className="text-xs text-gray-400 mt-2.5 text-center lg:text-left">
              🔒 Sigilo absoluto e resposta prioritária
            </p>
          </div>
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end relative">
          {/* Subtle Golden Ring Behind Lawyer Image */}
          <div className="relative w-full max-w-sm sm:max-w-md aspect-[3/4] rounded-2xl p-1 bg-gradient-to-b from-[#C8A45B]/60 via-[#111111]/80 to-[#C8A45B]/20 shadow-2xl shadow-black">
            ...
            <div className="relative w-full h-full rounded-xl overflow-hidden bg-[#0A0A0A] border border-[#C8A45B]/40 group">
              <img
                ...
                alt="Dra. Larisse - Frutuoso Advocacia"
                className="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105"
                referrerPolicy="no-referrer"
              />

              {/* Gradient overlay at bottom of portrait for seamless blending */}
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-90" />

              {/* Lawyer Title Overlay Card */}
